(custom-set-variables
 ...
 '(package-selected-packages
   '(gitconfig-mode flx-ido eimp editorconfig use-package-ensure-system-package use-package-chords smooth-scroll reveal-in-osx-finder prettier-js pdf-tools ns-auto-titlebar manage-minor-mode flycheck-pos-tip exec-path-from-shell dired-imenu delight company-tern company-auctex auto-package-update auto-compile auctex-latexmk apples-mode all-the-icons-dired ag 2048-game))
