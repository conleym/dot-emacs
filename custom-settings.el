(custom-set-variables
 ...
 '(package-selected-packages
   '(format-sql fill-column-indicator elpy pydoc zone-nyan yaml-mode xkcd web-mode tide smooth-scroll smex reveal-in-osx-finder rainbow-mode prettier-js pdf-tools nyan-mode nov ns-auto-titlebar markdown-mode manage-minor-mode gitignore-mode gitconfig-mode json-mode flycheck-pos-tip flycheck flx-ido ido-completing-read+ eimp editorconfig dockerfile-mode company-tern company-auctex company auto-package-update auto-compile auctex-latexmk apples-mode all-the-icons-dired all-the-icons ag 2048-game exec-path-from-shell use-package-chords use-package-ensure-system-package delight use-package))
