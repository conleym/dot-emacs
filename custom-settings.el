(custom-set-variables
 ...
 '(package-selected-packages
   '(docker aggressive-indent beacon lsp-mode vc-hooks tramp-cache nxml-mode js-mode files ede/base dired abbrev lsp-ui which-key flycheck-relint zone-nyan yaml-mode yagist xkcd web-mode vagrant-tramp vagrant unicode-troll-stopper twittering-mode tumblesocks tide sr-speedbar smooth-scroll smex smartparens reveal-in-osx-finder company-restclient restclient relint rainbow-delimiters rainbow-mode prettier-js pip-requirements pdf-tools paradox osx-location oauth nyan-mode nov noflet ns-auto-titlebar markdown-mode manage-minor-mode mac-pseudo-daemon lastpass json-mode jq-mode imenu-list ido-completing-read+ hungry-delete gitignore-mode gitconfig-mode gitattributes-mode git-timemachine flycheck-pos-tip flycheck flx-ido fill-column-indicator es-mode emr emojify emmet-mode elpy eimp editorconfig dockerfile-mode docker-tramp dired-imenu define-word crux company-emoji company-auctex company browse-at-remote auto-package-update auto-compile auctex-latexmk apples-mode all-the-icons-ibuffer all-the-icons-dired all-the-icons ag 2048-game exec-path-from-shell use-package-chords use-package-ensure-system-package delight use-package))
