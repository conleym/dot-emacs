(custom-set-variables
 ...
 '(package-selected-packages
   '(zone-nyan yaml-mode yagist xkcd which-key web-mode vagrant-tramp vagrant unicode-troll-stopper tide sr-speedbar smooth-scroll smex smartparens reveal-in-osx-finder company-restclient restclient rainbow-delimiters rainbow-mode prettier-js pip-requirements pdf-tools paradox osx-location oauth nyan-mode nov ns-auto-titlebar manage-minor-mode magit lsp-ui lsp-mode json-mode jq-mode imenu-list ido-completing-read+ hungry-delete git-modes git-timemachine flycheck-relint flycheck-pos-tip flycheck flx-ido fill-column-indicator es-mode emr emojify elpy eimp editorconfig dockerfile-mode docker dired-imenu define-word crux company-emoji company-auctex company browse-at-remote beacon auto-package-update auto-compile auctex-latexmk aggressive-indent all-the-icons-ibuffer all-the-icons-dired all-the-icons ag 2048-game exec-path-from-shell use-package-chords use-package-ensure-system-package delight use-package))
