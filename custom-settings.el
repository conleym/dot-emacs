(custom-set-variables
 ...
 '(package-selected-packages
   '(tern restclient flycheck company all-the-icons use-package yagist unicode-troll-stopper vagrant-tramp vagrant twittering-mode tumblesocks oauth smartparens all-the-icons-ibuffer rainbow-delimiters define-word zone-nyan yaml-mode xkcd web-mode use-package-ensure-system-package use-package-chords tide smooth-scroll smex reveal-in-osx-finder rainbow-mode prettier-js pip-requirements pdf-tools paradox nyan-mode ns-auto-titlebar nov noflet markdown-mode manage-minor-mode json-mode ido-completing-read+ hungry-delete gitignore-mode github-browse-file gitconfig-mode gitattributes-mode git-timemachine flycheck-pos-tip flx-ido fill-column-indicator exec-path-from-shell es-mode emr emmet-mode elpy eimp editorconfig dockerfile-mode delight crux company-tern company-restclient company-auctex auto-package-update auto-compile auctex-latexmk apples-mode all-the-icons-dired ag 2048-game))
